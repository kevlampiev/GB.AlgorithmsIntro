...
public class HomeWorkMenu
{
    ...
    public HomeWorkMenu()
    {
        ...
        _menuList[0] = new MenuItem { Description = "Урок 1", RunnerFunc = new LessonRunner(this.Lesson1) };
        _menuList[1] = new MenuItem { Description = "Урок 2", RunnerFunc = new LessonRunner(this.Lesson1) };
